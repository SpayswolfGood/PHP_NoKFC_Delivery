...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('app-api')->group(function () {
        ...
        Route::middleware('role:kitchen')->group(function () {
            ...
            Route::post('/kitchen/ingredients', [KitchenOrderController::class, 'storeIngredient']);
            Route::put('/kitchen/ingredients/{id}', [KitchenOrderController::class, 'updateIngredient']);
            Route::delete('/kitchen/ingredients/{id}', [KitchenOrderController::class, 'destroyIngredient']);
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::post('/admin/dishes/{dish}', [AdminDishController::class, 'update']);
